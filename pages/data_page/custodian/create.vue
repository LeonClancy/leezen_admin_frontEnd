            ...
            <div class="card">
                ...
                <div class="col-12 flex flex-column md:flex-row">
                    ...
                    <div class="field col-4">
                        ...
                        <div>
                            <Calendar id="custodian__birth_date" :class="[errors.birthday ? 'p-invalid' : '']"
                                type="text" v-model="birthday" v-bind="birthdayAttrs" />
                ...
                <div class="col-12 flex flex-column md:flex-row">
                    <div class="field col-4">
                        ...
                        <div>
                            <InputText id="custodian_phone" :class="[errors.contact_number ? 'p-invalid' : '']"
                                type="text" v-model="contact_number" v-bind="contact_numberAttrs" />
                    ...
                    <div class="field col">
                        ...
                        <div>
                            <Dropdown id="department" :class="[errors.department ? 'p-invalid' : '']"
                                v-model="department_id" v-bind="departmentAttrs" :options="departments"
